...
const AjouteCheque2 = ({ open, handleClose, onSubmitCheque }) => {
  const [cheque2Amount, setCheque2Amount] = useState(''); // Initialize with an empty string
  ...
  const handleCheque2Submit = () => {
    if (!cheque2Amount || !cheque2Bank || !cheque2PaymentDate) {
      alert("Please fill in all fields.");
      return;
    }

    const cheque2Data = {
      montant_cheque2: parseFloat(cheque2Amount),
